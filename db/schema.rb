...
ActiveRecord::Schema.define(version: 20160504075900) do
  ...
  add_index "tasks", ["assignee"], name: "index_tasks_on_assignee", using: :btree
  add_index "tasks", ["due_date"], name: "index_tasks_on_due_date", using: :btree
  add_index "tasks", ["reporter"], name: "index_tasks_on_reporter", using: :btree
